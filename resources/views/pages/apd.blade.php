            ...
            <div class="col-md-6 col-lg-4">
                <div class="card card-custom h-100">
                    <div class="card-header-custom">
                        ...
                        <img src="{{ asset('img/pelindungmata.jpg') }}" alt="Alat Pelindung Muka dan Mata" class="apd-image img-fluid">
                    </div>
                    <div class="card-body">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card card-custom h-100">
                    <div class="card-header-custom">
                        ...
                        <img src="{{ asset('img/pernapasan.jpg') }}" alt="Alat Pernapasan" class="apd-image img-fluid">
                    </div>
                    <div class="card-body">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card card-custom h-100">
                    <div class="card-header-custom">
                        ...
                        <img src="{{ asset('img/pelindungtelinga.jpg') }}" alt="Alat Pelindung Telinga" class="apd-image img-fluid">
                    </div>
                    <div class="card-body">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card card-custom h-100">
                    <div class="card-header-custom">
                        ...
                        <img src="{{ asset('img/pelindungtangan.jpg') }}" alt="Alat Pelindung Tangan" class="apd-image img-fluid">
                    </div>
                    <div class="card-body">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card card-custom h-100">
                    <div class="card-header-custom">
                        ...
                        <img src="{{ asset('img/pelindungkaki.jpg') }}" alt="Alat Pelindung Kaki" class="apd-image img-fluid">
                    </div>
                    <div class="card-body">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card card-custom h-100">
                    <div class="card-header-custom">
                        ...
                        <img src="{{ asset('img/pelindungbadan.jpg') }}" alt="Pakaian Pelindung" class="apd-image img-fluid">
                    </div>
                    <div class="card-body">
