...
<body>
    ...
    <section class="container py-5">
        ...
        <div class="row g-4">
            ...
            <div class="col-12">
                <div class="card procedure-card border-left-danger">
                    <div class="card-body p-4">
                        <div class="d-flex align-items-center mb-3">
                            <svg class="h-6 w-6 text-danger me-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-2">
                                ...
                                <span class="ms-2 small text-muted">Penyediaan APAR (Alat Pemadam Api Ringan) di seluruh area operasional untuk respons cepat.</span>
                            </div>
                            <div class="col-md-4 mb-2">
                                <span class="step-badge bg-danger text-white">2</span>
                                <span class="ms-2 small text-muted">APD khusus tim tanggap darurat: helm, sarung tangan tahan api, dan pakaian pelindung.</span>
                            </div>
                            <div class="col-md-4 mb-2">
                                <span class="step-badge bg-danger text-white">3</span>
                                <span class="ms-2 small text-muted">Jalur evakuasi jelas dengan denah K3 dipasang di lokasi strategis; simulasi evakuasi berkala.</span>
                            </div>
                        </div>
            ...
            <div class="col-12">
                <div class="card procedure-card border-left-warning">
                    <div class="card-body p-4">
                        <div class="d-flex align-items-center mb-3">
                            <svg class="h-6 w-6 text-warning me-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-2">
                                ...
                                <span class="ms-2 small text-muted">Safety shower & eyewash station tersedia di area laboratorium dan produksi untuk dekontaminasi cepat.</span>
                            </div>
                            <div class="col-md-4 mb-2">
                                <span class="step-badge bg-warning text-white">2</span>
                                <span class="ms-2 small text-muted">Prosedur penanganan limbah kimia berbahaya (B3) dengan APD khusus (sarung tangan, masker, dll.).</span>
                            </div>
                            <div class="col-md-4 mb-2">
                                <span class="step-badge bg-warning text-white">3</span>
                                <span class="ms-2 small text-muted">Laporan segera ke tim K3, isolasi area, dan penggunaan kit penyerap tumpahan.</span>
                            </div>
                        </div>
            ...
            <div class="col-12">
                <div class="card procedure-card border-left-success">
                    <div class="card-body p-4">
                        <div class="d-flex align-items-center mb-3">
                            <svg class="h-6 w-6 text-success me-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-2">
                                ...
                                <span class="ms-2 small text-muted">Kotak P3K (Cedera Unit Kerja) tersedia di setiap unit kerja untuk pertolongan pertama.</span>
                            </div>
                            <div class="col-md-4 mb-2">
                                <span class="step-badge bg-success text-white">2</span>
                                <span class="ms-2 small text-muted">Sistem pelaporan kecelakaan dan evakuasi ke fasilitas medis terdekat dengan protokol jelas.</span>
                            </div>
                            <div class="col-md-4 mb-2">
                                <span class="step-badge bg-success text-white">3</span>
                                <span class="ms-2 small text-muted">Penanggung jawab K3 di setiap unit untuk koordinasi respons cepat; simulasi darurat berkala.</span>
                            </div>
                        </div>
